      ...
      <div className="z-0 font-textFont w-full h-full grid grid-cols-2 justify-items-center gap-8 max-md:grid-cols-1">
        {projectsList.map((project, index) => {
          return (
            <div
              key={index}
              className="group flex flex-col justify-between items-center p-4 w-11/12 h-full rounded-2xl bg-lightTextOpacity text-lightBg dark:bg-darkTextOpacity dark:text-darkBg"
            >
              <div className="invisible group-hover:visible w-full h-full flex items-center justify-center m-2 text-black">
                <svg
