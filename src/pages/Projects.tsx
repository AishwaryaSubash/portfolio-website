...
const Projects = () => {
  ...
  return (
    <div className="pt-40 pb-20 flex flex-col gap-16 overflow-hidden justify-center items-center bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText max-md:gap-12 max-sm:gap-8">
