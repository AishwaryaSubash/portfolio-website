                ...
                <div className="w-full grid grid-cols-5 gap-8 justify-items-center items-end max-lg:grid-cols-4 max-md:grid-cols-3 max-sm:gap-4">
                  {skill.skillArray.map((item, index) => (
                    <div key={index} className="relative group">
                      ...
                      ></div>
                      <div className="z-10 absolute left-1/2 -translate-x-1/2 top-full mt-2 font-textFont w-max max-w-[140px] p-2 bg-gray-700 text-lightBg dark:bg-gray-200 dark:text-darkBg text-center text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                        {item.name}
                      </div>
                    </div>
                    // <div
          ...
          {professionalSkills.map((item, index) => (
            <div key={index} className="relative group">
              <div
                ...
                className="w-12 h-12 max-sm:w-8 max-sm:h-8"
              ></div>
              <div className="z-10 absolute left-full top-3/4 transform -translate-x-1/2 font-textFont w-fit p-2 bg-gray-700 text-lightBg dark:bg-gray-200 dark:text-darkBg text-center text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                {item.name}
              </div>
            </div>
            // <div
