...
const Skills = () => {
  ...
  return (
    <div className="mt-24 flex flex-col justify-center items-center bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText">
      <p className="text-6xl font-headingFont my-4">My Skills</p>
      ...
      <div className="mt-12 flex flex-col items-center justify-center">
        ...
        <div className="w-[95%] grid grid-cols-3 items-end justify-center max-lg:grid-cols-2 max-lg:gap-x-8 max-md:grid-cols-2">
