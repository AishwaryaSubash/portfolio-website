...
const ProjectPage = () => {
  ...
  return (
    <main className="pt-40 pb-20 w-full flex flex-col items-center gap-8 overflow-hidden bg-lightBg text-lightText dark:bg-darkBg dark:text-darkText max-sm:pt-32">
      <img
        src={project.websiteImg}
        alt={project.title}
        className="w-9/12 rounded-lg drop-shadow-md max-[895px]:w-full"
      />
      <div className="w-9/12 pt-40 flex gap-4 items-start max-[895px]:w-11/12 max-[895px]:pt-28 max-[895px]:flex-col max-[895px]:items-center max-sm:pt-20 max-xs:pt-12 max-sm:gap-4">
        <div className="min-w-[33%] flex flex-col gap-8 max-[895px]:w-11/12 max-[895px]:flex-row max-[895px]:justify-between max-sm:flex-col max-sm:gap-4">
          ...
          <div className="flex w-fit h-fit gap-4 text-lightText dark:text-darkText">
            ...
            >
              ...
              <div className="z-10 absolute left-[200%] top-full transform -translate-x-1/2 drop-shadow-2xl font-textFont w-max p-2 bg-gray-700 text-lightBg dark:bg-slate-400 dark:text-darkBg text-center text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                Website Link
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="z-10 absolute left-[300%] top-full transform -translate-x-1/2 font-textFont w-max p-2 bg-gray-700 text-lightBg dark:bg-slate-400 dark:text-darkBg text-center text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
